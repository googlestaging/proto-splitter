...
Usage: blaze run third_party/proto_splitter/testdata:many_field_gen -- \
    --path=/tmp/many_field
"""
...
def main(argv: Sequence[str]) -> None:
  ...
  path = os.path.join(SPLITTER_TESTDATA_PATH.value, "many-field.pbtxt")
  epath.Path(path).write_bytes(proto.SerializeToString(deterministic=True))
