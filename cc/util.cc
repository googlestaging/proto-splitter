...
absl::Status WalkFields(const ::proto2::Descriptor& desc,
  ...
  const ::proto2::Descriptor* message_desc = &desc;
  ...
  while (it != fields.end()) {
    ...
    RETURN_IF_ERROR(field_callback(field_desc));
...
absl::Status AddMapKey(const ::proto2::FieldDescriptor& key_field,
  ...
  switch (key_field.type()) {
    case ::proto2::FieldDescriptor::TYPE_BOOL: {
      ASSIGN_OR_RETURN(auto key, FieldBool(map_key));
      msg->set_boolean(key);
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_STRING: {
      msg->set_s(FieldString(map_key));
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_INT32: {
      ASSIGN_OR_RETURN(auto key, FieldInt(map_key));
      msg->set_i32(key);
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_INT64: {
      ASSIGN_OR_RETURN(auto key, FieldInt(map_key));
      msg->set_i64(key);
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_UINT32: {
      ASSIGN_OR_RETURN(auto key, FieldInt(map_key));
      msg->set_ui32(key);
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_UINT64: {
      ASSIGN_OR_RETURN(auto key, FieldInt(map_key));
      msg->set_ui64(key);
      break;
    }
    case ::proto2::FieldDescriptor::TYPE_FIXED64:
    case ::proto2::FieldDescriptor::TYPE_FIXED32:
    case ::proto2::FieldDescriptor::TYPE_SINT32:
    case ::proto2::FieldDescriptor::TYPE_SINT64:
    case ::proto2::FieldDescriptor::TYPE_SFIXED32:
    case ::proto2::FieldDescriptor::TYPE_SFIXED64:
      return absl::UnimplementedError(
          "Fixed map key types not implemented yet.");
    case ::proto2::FieldDescriptor::TYPE_DOUBLE:
    case ::proto2::FieldDescriptor::TYPE_FLOAT:
    case ::proto2::FieldDescriptor::TYPE_ENUM:
    case ::proto2::FieldDescriptor::TYPE_BYTES:
    case ::proto2::FieldDescriptor::TYPE_MESSAGE:
    case ::proto2::FieldDescriptor::TYPE_GROUP:
...
absl::StatusOr<const std::vector<Field>> GetFieldTypes(
    const ::proto2::RepeatedPtrField<::proto_splitter::FieldIndex>&
        field_tags) {
    ...
    switch (field_tags[fti].kind_case()) {
      case ::proto_splitter::FieldIndex::KindCase::kField:
        ...
        if (field_tags[fti].has_index()) {
          ...
          ASSIGN_OR_RETURN(const FieldType& map_key,
...
absl::Status AddMapEntry(::proto2::Message* message,
  ...
  const ::proto2::Reflection* reflection = map_entry->GetReflection();
  const ::proto2::FieldDescriptor* key =
      field_desc->message_type()->FindFieldByNumber(1);
  switch (key->cpp_type()) {
    case ::proto2::FieldDescriptor::CPPTYPE_INT32: {
      ASSIGN_OR_RETURN(auto map_key_int32, FieldInt(map_key));
      reflection->SetInt32(map_entry, key, map_key_int32);
      break;
    }
    case ::proto2::FieldDescriptor::CPPTYPE_INT64: {
      ASSIGN_OR_RETURN(auto map_key_int64, FieldInt(map_key));
      reflection->SetInt64(map_entry, key, map_key_int64);
      break;
    }
    case ::proto2::FieldDescriptor::CPPTYPE_UINT32: {
      ASSIGN_OR_RETURN(auto map_key_uint32, FieldInt(map_key));
      reflection->SetUInt32(map_entry, key, map_key_uint32);
      break;
    }
    case ::proto2::FieldDescriptor::CPPTYPE_UINT64: {
      ASSIGN_OR_RETURN(auto map_key_uint64, FieldInt(map_key));
      reflection->SetUInt64(map_entry, key, map_key_uint64);
      break;
    }
    case ::proto2::FieldDescriptor::CPPTYPE_BOOL: {
      ASSIGN_OR_RETURN(auto map_key_bool, FieldBool(map_key));
...
absl::StatusOr<MutableFieldResult> GetMutableField(
  ...
  ::proto2::Message* parent = message;
  const ::proto2::FieldDescriptor* field = nullptr;
  int index = -1;

  auto field_callback =
      [&parent, &field,
       &index](const ::proto2::FieldDescriptor* field_desc) -> absl::Status {
    const ::proto2::Reflection* reflection = parent->GetReflection();
    if (field != nullptr) {
  ...
  auto map_key_callback = [&parent, &field, &index](
    ...
    ASSIGN_OR_RETURN(int found_index,
  ...
  auto list_index_callback = [&parent, &field,
    ...
    ASSIGN_OR_RETURN(index, FieldInt(list_index));
    const ::proto2::Reflection* reflection = parent->GetReflection();
  ...
  RETURN_IF_ERROR(WalkFields(*message->GetDescriptor(), fields, field_callback,
                             map_key_callback, list_index_callback));
...
absl::StatusOr<MutableFieldResult> GetMutableField(
    ::proto2::Message* message, const FieldType& field_type) {
...
absl::StatusOr<FieldResult> GetField(const ::proto2::Message& message,
                                     const std::vector<FieldType>& fields) {
  const ::proto2::Message* parent = &message;
  const ::proto2::FieldDescriptor* field = nullptr;
  int index = -1;
...
absl::Status AddFieldTag(const ::proto2::Descriptor& desc,
  ...
  auto field_callback =
      [&chunked_field](
          const ::proto2::FieldDescriptor* field_desc) -> absl::Status {
  ...
  auto list_index_callback =
    ...
    ASSIGN_OR_RETURN(auto index, FieldInt(list_index));
...
absl::StatusOr<riegeli::RecordReader<riegeli::FileReader<>>> GetRiegeliReader(
  ...
  riegeli::RecordReader reader{riegeli::FileReader(cpb_file)};
  if (!reader.ok()) {
...
absl::StatusOr<bool> OnlyContainsPb(absl::string_view prefix) {
  ...
  bool is_pb = file::Exists(pb_file, file::Defaults()).ok();
  bool is_cpb = file::Exists(cpb_file, file::Defaults()).ok();
  if (is_pb && !is_cpb) {
    return true;
