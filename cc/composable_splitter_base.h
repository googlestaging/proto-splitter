...
==============================================================================*/
#ifndef PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
#define PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
...
class ComposableSplitterBase : public Splitter {
 public:
  explicit ComposableSplitterBase(::proto2::Message* message)
...
#endif  // PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
